...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"Madrid 2026","description":"Ferieinformasjon","base":"/madrid-2026/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"Home","link":"/"},{"text":"Transport","link":"/transport"}],"sidebar":[{"text":"Nyttig","items":[{"text":"Transport","link":"/transport"},{"text":"Runtime API Examples","link":"/api-examples"}]}],"socialLinks":[{"icon":"github","link":"https://github.com/vuejs/vitepress"}]},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
