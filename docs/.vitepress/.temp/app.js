import { ssrRenderAttrs, ssrRenderSlot, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderComponent, ssrRenderVNode, ssrRenderClass, ssrIncludeBooleanAttr, renderToString } from "vue/server-renderer";
...
import { u as useData$1, i as isExternal, t as treatAsHtml, w as withBase, a as isActive, g as getScrollOffset, o as onContentUpdated, E as EXTERNAL_URL_RE, b as useRoute, c as inBrowser, d as createTitle, m as mergeHead, p as pathToFile, R as RouterSymbol, e as initData, f as dataSymbol, C as Content, s as siteDataRef, h as createRouter } from "./Content.CUMdoxf-.js";
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "countdown" }, _attrs))} data-v-560052a2><p class="title" data-v-560052a2>Tid til avreise</p><p class="time" data-v-560052a2><strong data-v-560052a2>${ssrInterpolate(remaining.value.days)}</strong> dager <strong data-v-560052a2>${ssrInterpolate(pad(remaining.value.hours))}</strong> timer <strong data-v-560052a2>${ssrInterpolate(pad(remaining.value.minutes))}</strong> minutter </p></div>`);
    };
  }
};
...
const Countdown = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-560052a2"]]);
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    async function loadRate() {
      ...
      try {
        ...
        if (cdnResponse.ok) {
          ...
          const cdnRate = (_a = cdnData == null ? void 0 : cdnData.eur) == null ? void 0 : _a.nok;
        ...
        const pagesRate = (_b = pagesData == null ? void 0 : pagesData.eur) == null ? void 0 : _b.nok;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "VPFeatures currency-feature" }, _attrs))} data-v-69e5857a><div class="container" data-v-69e5857a><div class="items" data-v-69e5857a><div class="item grid-3" data-v-69e5857a><article class="VPFeature box" data-v-69e5857a><h2 class="title" data-v-69e5857a>Valutakalkulator</h2>`);
      if (loading.value) {
        _push(`<p class="details" data-v-69e5857a>Henter dagens EUR til NOK-kurs...</p>`);
      } else {
        _push(`<!--[-->`);
        if (error.value) {
          _push(`<p class="details warning" data-v-69e5857a>${ssrInterpolate(error.value)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<p class="rate" data-v-69e5857a>1 EUR = ${ssrInterpolate(formattedRate.value)} NOK</p><label class="field" for="eur-input" data-v-69e5857a><span class="label" data-v-69e5857a>EUR</span><input id="eur-input"${ssrRenderAttr("value", eurAmount.value)} type="number" min="0" step="0.01" data-v-69e5857a></label><p class="result" data-v-69e5857a>${ssrInterpolate(formattedNokAmount.value)} NOK</p><!--]-->`);
      }
      _push(`<button class="refresh" type="button" data-v-69e5857a> Oppdater kurs </button></article></div></div></div></section>`);
    };
  }
};
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../components/currency.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const Currency = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-69e5857a"]]);
const _sfc_main$1 = {
  __name: "weather",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    function representativeWeatherCode(date, index, daily, hourly) {
      const daytimeCodes = hourly.time.map((time, hourIndex) => ({
        time,
        code: hourly.weather_code[hourIndex],
        isDay: hourly.is_day[hourIndex]
      })).filter((hour) => hour.time.startsWith(date) && hour.isDay === 1).map((hour) => hour.code);
    ...
    async function loadForecast() {
      ...
      try {
        ...
        if (!((_a = daily == null ? void 0 : daily.time) == null ? void 0 : _a.length) || !((_b = hourly == null ? void 0 : hourly.time) == null ? void 0 : _b.length)) throw new Error("Invalid forecast data");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-19ff4c73><div class="heading" data-v-19ff4c73><div data-v-19ff4c73><p class="eyebrow" data-v-19ff4c73>Madrid, Spania</p><h2 id="weather-title" data-v-19ff4c73>Værmelding</h2></div><button type="button"${ssrIncludeBooleanAttr(loading.value) ? " disabled" : ""} data-v-19ff4c73>${ssrInterpolate(loading.value ? "Henter…" : "Oppdater")}</button></div>`);
      if (loading.value && !forecast.value.length) {
        _push(`<p class="status" data-v-19ff4c73>Henter værmeldingen…</p>`);
      } else if (error.value && !forecast.value.length) {
        _push(`<div class="status error" role="alert" data-v-19ff4c73><span data-v-19ff4c73>${ssrInterpolate(error.value)}</span><button type="button" data-v-19ff4c73>Prøv igjen</button></div>`);
      } else {
        _push(`<!--[--><div class="days" data-v-19ff4c73><!--[-->`);
        ssrRenderList(forecast.value, (day) => {
          _push(`<article class="day" data-v-19ff4c73><h3 data-v-19ff4c73>${ssrInterpolate(day.day)}</h3><span class="icon" role="img"${ssrRenderAttr("aria-label", day.description)} data-v-19ff4c73>${ssrInterpolate(day.icon)}</span><p class="description" data-v-19ff4c73>${ssrInterpolate(day.description)}</p><p class="temperature" data-v-19ff4c73><strong data-v-19ff4c73>${ssrInterpolate(day.max)}°</strong> <span data-v-19ff4c73>${ssrInterpolate(day.min)}°</span></p><p class="rain" title="Sannsynlighet for nedbør" data-v-19ff4c73>💧 ${ssrInterpolate(day.rain)} %</p></article>`);
        });
        _push(`<!--]--></div><p class="source" data-v-19ff4c73>Oppdatert ${ssrInterpolate(updatedAt.value)} · Data fra Open-Meteo</p>`);
        if (error.value) {
          _push(`<p class="inline-error" role="alert" data-v-19ff4c73>${ssrInterpolate(error.value)} Viser sist hentede varsel.</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--]-->`);
...
const Weather = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-19ff4c73"]]);
const address = "Calle de Guipúzcoa, 12, Madrid, Comunidad de Madrid 28020";
const _sfc_main = {
  __name: "maps",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-acf9d9eb><div class="heading" data-v-acf9d9eb><div data-v-acf9d9eb><p class="eyebrow" data-v-acf9d9eb>Reisemålet vårt</p><h2 id="destination-title" data-v-acf9d9eb>Calle de Guipúzcoa 12</h2></div><span aria-hidden="true" data-v-acf9d9eb>📍</span></div><a class="map-link"${ssrRenderAttr("href", mapUrl)} target="_blank" rel="noopener noreferrer"${ssrRenderAttr("aria-label", `Åpne ${address} i Google Maps`)} data-v-acf9d9eb><iframe${ssrRenderAttr("src", embedUrl)}${ssrRenderAttr("title", `Kart over ${address}`)} loading="lazy" referrerpolicy="no-referrer-when-downgrade" tabindex="-1" data-v-acf9d9eb></iframe><span class="open-map" data-v-acf9d9eb>Åpne i Google Maps ↗</span></a><p class="address" data-v-acf9d9eb>${ssrInterpolate(address)}</p></section>`);
    };
  }
};
const _sfc_setup = _sfc_main.setup;
...
const Maps = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-acf9d9eb"]]);
const RawTheme = {
  extends: theme,
  Layout: () => {
